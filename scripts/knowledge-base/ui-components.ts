...
ПРІОРИТЕТИ ПРИ ВІЗУАЛЬНОМУ ОФОРМЛЕННІ:
1. СПОЧАТКУ - кастомні Icon компоненти (якщо є відповідна іконка)
   Приклад: телефон, email, ціна, час, локація - використовуй <Icon>
2. ПОТІМ - emoji (якщо немає кастомної іконки, але потрібне візуальне підсилення)
   Приклад: для емоцій, підтримки живого діалогу, де немає відповідного Icon
3. ЗВИЧАЙНИЙ ТЕКСТ - де не потрібно візуальне підсилення

ВАЖЛИВО:
- Для списків ul/li НЕ використовуй emoji - ChevronRight додається автоматично
- Для контактів ЗАВЖДИ використовуй Icon з variant="default" (liquid glass)
- Emoji можна для живості діалогу, але кастомні іконки мають пріоритет
